...
class ScrapTrendAnalysisScreen extends StatefulWidget {
  const ScrapTrendAnalysisScreen({Key? key}) : super(key: key);

  @override
  _ScrapTrendAnalysisScreenState createState() =>
      _ScrapTrendAnalysisScreenState();
}

class _ScrapTrendAnalysisScreenState extends State<ScrapTrendAnalysisScreen> {
