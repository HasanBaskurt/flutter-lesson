...
class QueTrendAnalysisScreen extends StatefulWidget {
  const QueTrendAnalysisScreen({Key? key}) : super(key: key);

  @override
  _QueTrendAnalysisScreenState createState() => _QueTrendAnalysisScreenState();
}

class _QueTrendAnalysisScreenState extends State<QueTrendAnalysisScreen> {
